        ...
        <div className='mx-auto basis-11/12 lh:basis-10/12'>
          <div className='bg-white rounded-lg p-5 pb-0'>
            <div className='text-center flex justify-between flex-wrap'>
              <input defaultValue={userName} onChange={ChangeEvent} className='border pl-4 py-2 outline-none basis-full sm:basis-8/12 rounded-md shadow-md' type='text' placeholder='이름을 입력해주세요' />
